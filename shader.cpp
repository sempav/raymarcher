...
bool GLProgram::SetUniformMat2(const char *name, GLsizei count, GLboolean transpose,
                               const GLfloat *value) {
    GLint t;
    if (!GetUniform(&t, name)) return false;
...
bool GLProgram::SetUniformMat3(const char *name, GLsizei count, GLboolean transpose,
                               const GLfloat *value) {
    GLint t;
    if (!GetUniform(&t, name)) return false;
...
bool GLProgram::SetUniformMat4(const char *name, GLsizei count, GLboolean transpose,
                               const GLfloat *value) {
    GLint t;
    if (!GetUniform(&t, name)) return false;
