...
public:
	...
	void LookAt(glm::vec3 pos, glm::vec3 dir, glm::vec3 up) { SetPos(pos); SetDir(dir); SetUp(up); }
...
class SmoothCamera: public Camera
{
	glm::vec3 speed;
public:
	SmoothCamera(glm::vec3 pos = glm::vec3(0.0f),
		    glm::vec3 dir = glm::vec3(0.0f, 0.0f, 1.0f),
		    glm::vec3 up  = glm::vec3(0.0f, 1.0f, 0.0f)) : Camera(pos, dir, up), speed(0) { }
	~SmoothCamera(void) { }
